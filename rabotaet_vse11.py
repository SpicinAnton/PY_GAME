...
def generate_level(level):
    ...
    return new_player, x, y, speedpotion, portal
...
player, max_x, max_y, speedpotion, portal = generate_level(level_map)
...
while run:
    for event in pygame.event.get():
        ...
        if tp:
            portal.kill()
            player.kill()
            player, max_x, max_y, speedpotion, portal = generate_level(level_map1)
